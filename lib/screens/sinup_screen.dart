...
import 'package:appins/resources/auth_methods.dart';
...
import 'package:appins/widgets/text_field_input.dart';
...
class _SignupScreenState extends State<SignupScreen> {
  ...
  void signUpUser() async {
    ...
    // // người dùng đăng ký bằng authmethodds và lấy kết quả trả về
    String res = await AuthMethods().signUpUser(
        ...
        file: _image!);
    // nếu chuỗi trả về là thành công, người dùng đã được tạo
    if (res == "Thành công") {
      setState(() {
        _isLoading = false;
      });
